...
<html>
 ...
 <body>
	...
	<div class="panel panel-default">
	  ...
	  <div class="panel-heading">新增车位信息
	  </div>
	  ...
	  <div class="container">
	    ...
	    <form class="form-horizontal" action="save.action" method="post" style="padding-top:20px;">
	      <div class="form-group">
		    ...
		    <div class="col-sm-4">
		      <input type="text" class="form-control"  name="parkingPlaceVO.code" id="inputcode" placeholder="品牌">
		    </div>
		  </div>
		  <div class="form-group">
		    <label for="inputcarplace" class="col-sm-4 control-label">所在位置</label>
		    <div class="col-sm-4">
		      <input type="text" class="form-control" name="parkingPlaceVO.carplace" id="inputcarplace" placeholder="所在位置">
		    </div>
		  </div>
		  <div class="form-group">
