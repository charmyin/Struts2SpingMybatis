	  ...
	  <div class="container">
	    ...
	    <form class="form-horizontal" action="save.action" method="post" style="padding-top:20px;">
	      <div class="form-group">
		    ...
		    <div class="col-sm-4">
		      <input type="text" class="form-control"  name="parkingPlaceVO.code" id="inputcode" placeholder="车牌号">
		    </div>
		  </div>
		  <div class="form-group">
		    <label for="inputcarplace" class="col-sm-4 control-label">所在位置</label>
		    <div class="col-sm-4">
		      <input type="text" class="form-control"  name="parkingPlaceVO.carplace" id="inputcarplace" placeholder="车辆信息">
		    </div>
		  </div>
		  <div class="form-group">
		    <label for="inputuserid" class="col-sm-4 control-label">所属业主</label>
		    <div class="col-sm-4">
		      <input type="text" class="form-control"  name="parkingPlaceVO.userid" id="inputuserid" placeholder="所属业主">
		    </div>
		  </div>
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-4">
		      <input type="text" class="form-control"  name="parkingPlaceVO.remark" id="inputremark" placeholder="备注">
		    </div>
		  </div>
