...
<html>
 ...
 <body>
	...
	<div class="panel panel-default">
	  ...
	  <div class="panel-heading">新增业主信息
	  </div>
	  ...
	  <div class="container">
	    ...
	    <form class="form-horizontal" action="save.action" method="post" style="padding-top:20px;">
		  <div class="form-group">
		    ...
		    <div class="col-sm-4">
		      <input type="text" class="form-control" name="userVO.name" id="inputname" placeholder="用户名">
		    </div>
		  </div>
		  <div class="form-group">
		    <label for="inputloginid" class="col-sm-4 control-label">登录名</label>
		    <div class="col-sm-4">
		      <input type="text" class="form-control"  name="userVO.loginid" id="inputloginid" placeholder="登录名">
		    </div>
		  </div>
		  <div class="form-group">
		    <label for="inputphone" class="col-sm-4 control-label">手机</label>
		    <div class="col-sm-4">
		      <input type="text" class="form-control"  name="userVO.phone" id="inputphone" placeholder="手机">
		    </div>
		  </div>
		  <div class="form-group">
		    <label for="inputaddress" class="col-sm-4 control-label">住址</label>
		    <div class="col-sm-4">
		      <input type="text" class="form-control"  name="userVO.address" id="inputaddress" placeholder="住址">
		    </div>
		  </div>
