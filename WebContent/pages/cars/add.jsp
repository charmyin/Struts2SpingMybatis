...
<html>
 ...
 <body>
	...
	<div class="panel panel-default">
	  ...
	  <div class="panel-heading">新增车辆信息
	  </div>
	  ...
	  <div class="container">
	    ...
	    <form class="form-horizontal" action="save.action" method="post" style="padding-top:20px;">
		  <div class="form-group">
		    ...
		    <div class="col-sm-4">
		      <input type="text" class="form-control" name="carVO.platenumber" id="inputplatenumber" placeholder="车牌号">
		    </div>
		  </div>
		  <div class="form-group">
		    <label for="inputbrand" class="col-sm-4 control-label">品牌</label>
		    <div class="col-sm-4">
		      <input type="text" class="form-control"  name="carVO.brand" id="inputbrand" placeholder="品牌">
		    </div>
		  </div>
		  <div class="form-group">
		    <label for="inputmodel" class="col-sm-4 control-label">型号</label>
		    <div class="col-sm-4">
		      <input type="text" class="form-control"  name="carVO.model" id="inputmodel" placeholder="型号">
		    </div>
		  </div>
		  <div class="form-group">
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-4">
		      <input type="text" class="form-control"  name="carVO.enginenumber" id="inputenginenumber" placeholder="发动机号">
		    </div>
		  </div>
